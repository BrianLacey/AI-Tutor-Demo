...
if (!supabaseUrl || !supabaseRoleKey || !supabasePublicKey) {
  throw new Error("Missing Supabase server variables.");
}

export const supabaseAdminServer = createClient(supabaseUrl, supabaseRoleKey);

export const supabaseUserServer = async () => {
